package com.laofeizhu.admin.common.system.util;
...
import com.laofeizhu.admin.common.constant.DataBaseConstant;
...
public class JwtUtil {
	...
	public static String getSessionData(String key) {
		...
		if (oConvertUtils.isNotEmpty(key)) {
			HttpSession session = SpringContextUtils.getHttpServletRequest().getSession(false);
